# Arduino-LCD16x2-i2c
LCD 16x2 with Arduino and i2c Interface

This project helps you to print simple text and numbers on a 16x2 LCD display connected to an Arduino 
...
1. Past the second code (lcd.ino) in the IDE
